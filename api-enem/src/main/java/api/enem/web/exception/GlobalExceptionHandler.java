...
//    }
    ...
    @ExceptionHandler(NoExamsFoundException.class)
    public ResponseEntity<ErrorMessage> handleNoExamsFoundException(
            NoExamsFoundException ex,
            HttpServletRequest request) {

        log.warn("No exams found: {}", ex.getMessage());
        return ResponseEntity
    ...
    public ResponseEntity<ErrorMessage> handleNoQuestionsFoundException(
            NoQuestionsFoundException ex,
            HttpServletRequest request) {

        log.warn("No questions found: {}", ex.getMessage());
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .contentType(MediaType.APPLICATION_JSON)
                .body(new ErrorMessage(
    ...
    public ResponseEntity<ErrorMessage> handleUserAlreadyExists(UserAlreadyExists ex,
                                                                            HttpServletRequest request) {
        log.error("********** API ERROR **********", ex);
        return ResponseEntity
    ...
    public ResponseEntity<ErrorMessage> handleExternalApiRateLimitException(ExternalApiRateLimitException ex,
                                                                  HttpServletRequest request) {
        log.error("********** API ERROR **********", ex);
        return ResponseEntity
